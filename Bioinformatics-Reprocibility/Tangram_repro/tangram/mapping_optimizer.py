...
class Mapper:
    ...
    def _loss_fn(self, verbose=True):
        ...
        gv_reg = (gv_term / self.lambda_g1).tolist()
        ...
        if verbose:
            ...
            term_numbers = [total_loss.tolist(), gv_reg,    vg_reg,   d_reg,    entropy_reg]
            term_names =   ["Score",            "GV reg",  "VG reg", "KL reg", "Entropy reg"]
        ...
        return total_loss, gv_reg, vg_reg, d_reg, entropy_reg

    def train(self, num_epochs, learning_rate=0.1, print_each=10):
        """
